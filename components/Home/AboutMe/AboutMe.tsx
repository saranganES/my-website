...
export default function AboutMe(props) {
  const technologies = [
    ['Next.js', 'JavaScript (ES6+)', 'Bootstrap', 'Tailwind CSS', 'Redux'],
    ['React.js', 'Node.js', 'TypeScript', 'Framer Motion', 'Context'],
  ];
  return (
    <div
      id='aboutSection'
        ...
        <div className='w-full flex flex-col md:flex-row space-y-8 md:space-y-0 md:space-x-8 sm:space-x-2 '>
          <div className='w-full md:w-7/12 space-y-4 sm:text-base text-sm '>
            <div className='font-Header '>
              <span className='text-gray-400  tracking-wide'>
                Hello! My name is Sarangan, and I enjoy solving problems and
                creating code for the web. My interest in computer science began
                back in 2016 when I decided to pursue a
                <span className='text-AAsecondary'>
                  {' '}
                  BE in Computer Science
                </span>
                . It turns out programming skills are essential for that, and my
                journey with programming has continued ever since!
              </span>
            </div>
          ...
          <div className='group relative lg:w-96 lg:h-96 md:w-72 md:h-72 md:block hidden '>
            ...
            <div className='absolute w-5/6 h-5/6  rounded overflow-hidden'>
              <div className='absolute w-full h-full group-hover:opacity-0 bg-black hover:invert transition opacity-20 duration-300 rounded overflow-hidden'></div>
              <Img
                src={'/profile.png'}
