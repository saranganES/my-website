...
const IconsData = [
  { href: "https://github.com/saranganES", Icon: GithubIcon },
  { href: "https://www.linkedin.com/in/sarangan-e-802b55212", Icon: LinkedinIcon },
    ...
    text-sm  space-y-2  "
        >
          <span className="group-hover:text-AAsecondary sm:text-sm text-xs">
            Designed & Built by Sarangan Elangovan
          </span>
        </div>
      </a>
    </div>
